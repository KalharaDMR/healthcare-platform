...
public class AppointmentService {
    ...
    private final AppointmentRepository appointmentRepository;
    private final DoctorServiceClient doctorServiceClient;
    private final AppointmentEmailNotificationService appointmentEmailNotificationService;

    public AppointmentService(AppointmentRepository appointmentRepository,
                              DoctorServiceClient doctorServiceClient,
                              AppointmentEmailNotificationService appointmentEmailNotificationService) {
        this.appointmentRepository = appointmentRepository;
        this.doctorServiceClient = doctorServiceClient;
        this.appointmentEmailNotificationService = appointmentEmailNotificationService;
    }
    ...
    public AppointmentResponse book(String patientUsername, AppointmentCreateRequest request,Boolean isEnableVideo) {
        ...
        try {
            ...
            appointmentEmailNotificationService.sendBookingConfirmation(response);
            return response;
        } catch (RuntimeException ex) {
            doctorServiceClient.release(request.getSlotId());
            throw ex;
