...
* The original package name ' com.healthcare.notification-service' is invalid and this project uses 'com.healthcare.notification_service' instead.
...
* [Prometheus](https://docs.spring.io/spring-boot/3.5.13/reference/actuator/metrics.html#actuator.metrics.export.prometheus)
